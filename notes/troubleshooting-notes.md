...
# 15. Final Troubleshooting Status
...
Improve Windows endpoint telemetry collection and repeat the controlled download so that the following correlation can be validated:
...
This would turn the current partial investigation into a more complete SOC download investigation.
